...
### Added
- `Builder#empty?` — `true` when zero data rows would be emitted; respects filters, sort, offset, and limit. Saves callers from generating CSV just to check emptiness.
